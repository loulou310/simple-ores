...
public class EmeraldAxeItem extends SimpleOresModElements.ModElement {
	@ObjectHolder("simple_ores:emerald_axe")
	public static final Item block = null;
	public EmeraldAxeItem(SimpleOresModElements instance) {
		super(instance, 52);
	}
