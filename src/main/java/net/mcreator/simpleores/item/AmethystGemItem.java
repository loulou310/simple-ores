...
public class AmethystGemItem extends SimpleOresModElements.ModElement {
	@ObjectHolder("simple_ores:amethyst_gem")
	public static final Item block = null;
	public AmethystGemItem(SimpleOresModElements instance) {
		super(instance, 63);
	}
