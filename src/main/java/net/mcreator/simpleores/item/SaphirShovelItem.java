...
public class SaphirShovelItem extends SimpleOresModElements.ModElement {
	@ObjectHolder("simple_ores:saphir_shovel")
	public static final Item block = null;
	public SaphirShovelItem(SimpleOresModElements instance) {
		super(instance, 32);
	}
